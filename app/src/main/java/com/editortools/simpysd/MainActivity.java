...
import com.editortools.simpysd.databinding.ActivityMainBinding;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_REQUEST_CODE) {
            if (data.getData() != null) {
                ...
                dsPhotoEditorIntent.putExtra(DsPhotoEditorConstants.DS_PHOTO_EDITOR_OUTPUT_DIRECTORY, "SimpyEditor");
